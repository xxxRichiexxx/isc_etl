...
WITH 
    sq AS(
        SELECT HASH("Дивизион", "Название", "Полное название (организация)", "Название из системы скидок")
...
WHERE DATE_TRUNC('MONTH', load_date) IN(
    ...
    AND HASH("division", "Recipient", "RecipientFullName", "CustomerFromDiscountSystem")
