...
--	,"Продано в розницу" AS "Продано в розницу_"
	,SUM("Продано в розницу") OVER (PARTITION BY data."Месяц", "Стоянка ID")																	AS "Продано в розницу"
	,SUM("Продано в розницу") OVER (PARTITION BY data."Месяц", "Территория продаж")																AS "Общие продажи в субъекте"
