...
"ВИН", "Вариант сборки", "Номерной товар ИД", "Розница ТП", "Остаток НП+ВПути", "Остаток КП+ВПути", "Остаток НП", "Остаток КП",
...
WITH
	...
	sq4 AS(
		SELECT 
			...
			COALESCE(b."Остатки на КП", 0)														A		AS "Остатки на КП",
		...
		LEFT JOIN sales_1 																				AS s1_1
			...
			AND sq3."Направление реализации с учетом УКП" = s1_1."Направление реализации с учетом УКП" 
			AND sq3."ВИН" = s1_1."ВИН"
			AND sq3."Вариант сборки" = s1_1."Вариант сборки"
			AND sq3."Номерной товар ИД" = s1_1."Номерной товар ИД"
		LEFT JOIN sales_1																				AS s1_2
			...
			AND sq3."Направление реализации с учетом УКП" = s1_2."Направление реализации с учетом УКП"
			AND sq3."ВИН" = s1_2."ВИН"
			AND sq3."Вариант сборки" = s1_2."Вариант сборки"
			AND sq3."Номерной товар ИД" = s1_2."Номерной товар ИД"
		LEFT JOIN sales_2 																				AS s2
			...
			AND sq3."Направление реализации с учетом УКП" = s2."Направление реализации с учетом УКП"
			AND sq3."ВИН" = s2."ВИН"
			AND sq3."Вариант сборки" = s2."Вариант сборки"
			AND sq3."Номерной товар ИД" = s2."Номерной товар ИД"
		LEFT JOIN balance																				AS b
			...
			AND sq3."Направление реализации с учетом УКП" = b."Направление реализации с учетом УКП"	
			AND sq3."ВИН" = b."ВИН"
			AND sq3."Вариант сборки" = b."Вариант сборки"
			AND sq3."Номерной товар ИД" = b."Номерной товар ИД"	
	)
SELECT
