...
WITH
	...
	sq4 AS(
		...
		LEFT JOIN sales_1 																				AS s1_1
			...
			AND HASH(sq3."Дивизион", sq3."Дилер", sq3."Территория продаж", sq3."Внутренний код", sq3."Направление реализации по приложению")
				= HASH(s1_1."Дивизион", s1_1."Дилер", s1_1."Территория продаж", s1_1."Внутренний код", s1_1."Направление реализации по приложению")
		LEFT JOIN sales_1																				AS s1_2
			...
			AND HASH(sq3."Дивизион", sq3."Дилер", sq3."Территория продаж", sq3."Внутренний код", sq3."Направление реализации по приложению")
				= HASH(s1_2."Дивизион", s1_2."Дилер", s1_2."Территория продаж", s1_2."Внутренний код", s1_2."Направление реализации по приложению")
		LEFT JOIN sales_2 																				AS s2
			...
			AND HASH(sq3."Дивизион", sq3."Дилер", sq3."Территория продаж", sq3."Внутренний код", sq3."Направление реализации по приложению")
				= HASH(s2."Дивизион", s2."Дилер", s2."Территория продаж", s2."Внутренний код", s2."Направление реализации по приложению")
		LEFT JOIN balance																				AS b
			ON DATE_TRUNC('MONTH', sq3."Дата") = b."Период"
			AND HASH(sq3."Дивизион", sq3."Дилер", sq3."Территория продаж", sq3."Внутренний код", sq3."Направление реализации по приложению")
				= HASH(b."Дивизион", b."Дилер", b."Территория продаж", b."Внутренний код", b."Направление реализации по приложению")
	)
SELECT
	"Дата",
	"Дилер",
